                        ...
                        for element in live_elements:
                            if element["id"] == player_id:
                                ...
                                if multiplier in [1, 2, 3]:
                                    player_info[player_id]["expected_assists_team"] += float(expected_assists)
                                    player_info[player_id]["expected_assists_team"] = round(player_info[player_id]["expected_assists_team"], 2) # Round to one decimals
                                    player_info[player_id]["expected_goals_team"] += float(expected_goals)
                                    player_info[player_id]["expected_goals_team"] = round(player_info[player_id]["expected_goals_team"], 2) # Round to one decimals
                                    ...
                                    player_info[player_id]["goals_performance_team"] = round(float(player_info[player_id]["goals_scored_team"]) - float(player_info[player_id]["expected_goals_team"]), 2)
                                    player_info[player_id]["assists_performance_team"] = round(float(player_info[player_id]["assists_team"]) - float(player_info[player_id]["expected_assists_team"]), 2)
                                    player_info[player_id]["expected_goal_involvements_team"] = round(player_info[player_id]["expected_goals_team"] + player_info[player_id]["expected_assists_team"], 2)
                                    player_info[player_id]["goals_assists_performance_team"] = round(float(player_info[player_id]["goals_assists_team"]) - float(player_info[player_id]["expected_goal_involvements_team"]), 2)
                                    player_info[player_id]["goals_assists_performance_team_vs_total"] = player_info[player_id]["goals_assists_performance_team"] - player_info[player_id]["goals_assists_performance"]
